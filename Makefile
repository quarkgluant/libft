...
#                                                 +#+#+#+#+#+   +#+            #
#    Created: 2016/11/03 20:57:46 by pcadiot           #+#    #+#              #
#    Updated: 2016/11/03 20:57:54 by pcadiot          ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
NAME=libft.a
SRC=ft_putchar.c ft_putstr.c ft_strcmp.c ft_strlen.c ft_atoi.c ft_memset.c \
	...
	ft_strrchr.c ft_toupper.c ft_tolower.c ft_lstdup.c ft_tab_int_max.c \
